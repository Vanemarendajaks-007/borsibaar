...
export default function Inventory() {
  ...
  return (
    <div className="min-h-screen bg-background p-2 sm:p-4">
        {/* Header Card */}
        <div className="rounded-lg bg-card p-3 sm:p-4 lg:p-6 shadow-sm mb-3 sm:mb-4 border-1 border-[color-mix(in_oklab,_var(--ring)_50%,_transparent)]">
            ...
            <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
              <div className="relative flex-shrink-0">
                ...
                <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 sm:w-3.5 sm:h-3.5 bg-amber-400 rounded-full border-2 border-card flex items-center justify-center">
                  <span className="text-[6px] sm:text-[7px] font-bold text-amber-900">{inventory.length}</span>
                </div>
              </div>
        ...
        {/* Main Content Card */}
        <div className="rounded-lg bg-card p-3 sm:p-4 lg:p-6 shadow-sm border-1 border-[color-mix(in_oklab,_var(--ring)_50%,_transparent)]">
